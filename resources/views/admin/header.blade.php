        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                ...
                @if(\Auth::user()->type=='owner' )
                    {{-- <li>
                        <a href="#" class="navicon-wrap copy_link" data-url="{{route('ticket',\Auth::user()->code)}}"
                           data-bs-toggle="tooltip"
                           data-bs-original-title="{{__('Click to Copy')}}"><i
                                class="fa fa-copy fs-15"></i></a>
                    </li> --}}
                    <li class="dropdown pc-h-item">
                        <a href="#"
                            class="pc-head-link head-link-secondary dropdown-toggle arrow-none me-0 copy_link"
                            data-url="{{route('ticket',\Auth::user()->code)}}" data-bs-placement="bottom"
