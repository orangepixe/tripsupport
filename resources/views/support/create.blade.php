{{Form::open(array('url'=>'ticket','method'=>'post', 'enctype' => "multipart/form-data"))}}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            {{Form::label('attachment',__('File Attachment'),array('class'=>'form-label'))}}
            {{Form::file('attachment[]',array('class'=>'form-control','multiple'))}}
        </div>
        <div class="form-group  col-md-12">
