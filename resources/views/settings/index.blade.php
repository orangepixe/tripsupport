                                ...
                                @if (Gate::check('manage company settings'))
                                    <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('ticket_number_prefix', __('Ticket Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('ticket_number_prefix', $settings['ticket_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter Ticket number prefix')]) }}
                                            </div>
