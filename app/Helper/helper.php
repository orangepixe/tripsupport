...
if (!function_exists('ticketPrefix')) {
    function ticketPrefix()
    {
        $settings = settings();
        return $settings["ticket_number_prefix"];
    }
}
    ...
    function defaultTemplate($id)
    {
        $templateData = [
            ...
            [
                ...
                'name' => 'New Ticket',
                'short_code' => ['{requester_name}', '{ticket_id}', '{ticket_status}', '{ticket_headline}', '{ticket_category}', '{ticket_importance}', '{ticket_message}', '{ticket_url}'],
                'subject' => 'Support Ticket',
                'template' => '
                <p><strong>Dear {requester_name},</strong></p>
                <p>Thank you for registering with us. Here are the details of your visit:</p>
                <blockquote>
                    <p><strong>Ticket ID:</strong>{ticket_id}</p>
                    <p><strong>Status:</strong> {ticket_status}</p>
                    <p><strong>Head Line:</strong> {ticket_headline}</p>
                    <p><strong>Category:</strong> {ticket_category}</p>
                    <p><strong>Importance:</strong> {ticket_importance}</p>
                    <p><strong>Message:</strong> {ticket_message}</p>
                    <p>We are committed to resolving your issue as quickly as possible. If you have additional questions or need further assistance, please don not hesitate to contact us.</p>
                    <p>
            ...
            [
                ...
                'short_code' => ['{assignment_name}', '{ticket_id}', ' {ticket_status}', ' {requester_name}', ' {ticket_headline}', ' {ticket_category}', ' {ticket_importance}', ' {ticket_message}', '{ticket_url}'],
                'subject' => 'Support Ticket Assignment',
                'template' => '
                <p><strong>Dear {assignment_name},</strong></p>
                <p>A new support ticket has been assigned to you. Please review the details below:</p>
                <blockquote>
                    <p><strong>Ticket ID:</strong>{ticket_id}</p>
                    <p><strong>Status:</strong> {ticket_status}</p>
                    <p><strong>Customer:</strong> {requester_name}</p>
                    <p><strong>Head Line:</strong> {ticket_headline}</p>
                    <p><strong>Category:</strong> {ticket_category}</p>
                    <p><strong>Importance:</strong> {ticket_importance}</p>
                    <p><strong>Message:</strong> {ticket_message}</p>
            ...
            [
                ...
                'name' => 'Ticket Reply',
                'short_code' => ['{receiver_name}', '{ticket_id}', '{headline}', '{response}', '{ticket_url}'],
                'subject' => 'Ticket Reply - We are Here to Help!',
                'template' => '
                <p><strong>Dear {receiver_name},</strong></p>
                <p>Thank you for reaching out to us. We have reviewed your ticket<strong>{ticket_id}</strong>, and here is our response:</p>
                <blockquote>
                   <p><strong>Your Headline:</strong></p>
                    <p>{headline}</p>
                    <p><strong>Our Answer:</strong></p>
                    <p>{response}</p>
                    <p>If you have further questions or need additional clarification, feel free to reply to this email or contact us directly. We are always here to assist you!</p>
                    <p>
                        <a href="{ticket_url}" class="button">View Ticket</a>
                    </p>
                    <p>Best regards,</p>
...
if (!function_exists('MessageReplace')) {
    function MessageReplace($notification, $id = 0)
    {
        ...
        if (!empty($notification)) {
            ...
            if ($notification->module == 'ticket_create') {
                $support = Support::find($id);
                $ticket_id = ticketPrefix() . $support->support_id;
                $requester_name = !empty($support->clients) ? $support->clients->name : '-';
                $ticket_category = !empty($support->categories) ? $support->categories->category : '-';
                $ticket_url = route('ticket.show', \Crypt::encrypt($support->id));
                $search = ['{requester_name}', '{ticket_id}', '{ticket_status}', '{ticket_headline}', '{ticket_category}', '{ticket_importance}', '{ticket_message}', '{ticket_url}'];
                $replace = [$requester_name, $ticket_id, $support->stage, $support->headline, $ticket_category, $support->importance, $support->summary, $ticket_url];
            }
            if ($notification->module == 'ticket_assignment') {
                $support = Support::find($id);
                $ticket_id = ticketPrefix() . $support->support_id;
                $assignment_name = !empty($support->assignments) ? $support->assignments->name : '-';
                $requester_name = !empty($support->clients) ? $support->clients->name : '-';
                $ticket_category = !empty($support->categories) ? $support->categories->category : '-';
                $ticket_url = route('ticket.show', \Crypt::encrypt($support->id));
                $search = ['{assignment_name}', '{ticket_id}', ' {ticket_status}', ' {requester_name}', ' {ticket_headline}', ' {ticket_category}', ' {ticket_importance}', ' {ticket_message}', '{ticket_url}'];
                $replace = [$assignment_name, $ticket_id, $support->stage, $requester_name, $support->headline, $ticket_category, $support->importance, $support->summary, $ticket_url];
            }
            if ($notification->module == 'ticket_assignment_update') {
                $SupportReply = SupportReply::find($id);
                $reply = $SupportReply->description;
                $support = $SupportReply->supportTicket;
                $receiver_name = '';
                $ticket_id = ticketPrefix() . $support->headline;
                $ticket_url = route('ticket.show', \Crypt::encrypt($support->id));
                $search = ['{receiver_name}', '{ticket_id}', '{headline}', '{response}', '{ticket_url}'];
                $replace = [$receiver_name, $ticket_id, $support->headline, $reply, $ticket_url];
            }
    ...
    function HomePageSection()
    {
        $retuen = [
            ...
            [
                'title' => 'Banner',
                'section' => 'Section 1',
                'content_value' => '{"name":"Banner","section_enabled":"active","title":"Support Desk - Helpdesk Ticket Management Tool","sub_title":"Support Desk is a comprehensive helpdesk ticket management tool designed to streamline customer support operations. It enables businesses to efficiently manage incoming support requests, track ticket status, and provide timely assistance to customers.","btn_name":"Get Started","btn_link":"#","section_footer_text":"Manage your business efficiently with our all-in-one solution designed for performance, security, and scalability.","section_footer_image":{},"section_main_image":{},"section_footer_image_path":"upload\/homepage\/banner_2.png","section_main_image_path":"upload\/homepage\/banner_1.png","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                <header id="home">
                    <div class="container">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-5 col-xl-4">
                                <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <span class="text-primary">Support Desk - Helpdesk Ticket Management Tool</span>
                                </h1>
                                <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                                    Support Desk is a comprehensive helpdesk ticket management tool designed to streamline customer support operations. It enables businesses to efficiently manage incoming support requests, track ticket status, and provide timely assistance to customers.
                                </h4>
                        ...
                        <div class="container">
                            <div class="row align-items-center g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-lg w-75 my-3 my-md-4">Support Desk has made it easy for developers of any skill level to
                                        use their product.</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                <h2 class="h1">What does Support Desk offer?</h2>
                                <p class="text-lg">
                                    Support Desk is a reliable choice for your admin panel needs, offering a wide range of features to
                        ...
                        <div class="row g-4 text-center">
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Support Desk can improve the user experience of your web application by providing a clear and intuitive
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Support Desk can save developers time and effort by providing a pre-built user interface, allowing them
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>Support Desk simplifies admin panel development with easy theme setup and clear code with flexible
                                    layouts options.</p>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Support Desk uses scalable technologies and resources to ensure that your admin panel remains efficient
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    ...
                                    and effectively use the Support Desk.
                                </p>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <img src="assets/images/landing/img-design-6.svg" alt="img" class="img-fluid" />
                                <h3 class="my-4 fw-semibold">Performance Centric</h3>
                                <p>Support Desk is a performance-centric dashboard template that is designed to deliver optimal performance
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">Support Desk has conceptul working apps like Chat, Inbox, E-commerce, Invoice,
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">Support Desk has conceptul working apps like Chat, Inbox, E-commerce, Invoice, Kanban,
                                    and Calendar</p>
                            </div>
                        </div>
                        <div class="row text-center justify-content-center">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-9">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <h2 class="mb-0 text-white">Choose Support Desk for</h2>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col-12">
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        ...
                                        <b>Is Support Desk Support Typescript?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        Yes, Support Desk Support the TypeScript and it is only available in Plus and Extended License.
                                        </div>
                                    </div>
                                    </div>
                                    <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingfour">
                                        ...
                                        <b>Is there any Road map for Support Desk?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapse-four" class="accordion-collapse collapse" aria-labelledby="flush-headingfour"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        Support Desk is our flagship React Dashboard Template and we always add the new features for the long
                                        run. You can check
            ...
            [
                ...
                'section' => 'Section 10',
                'content_value' => '{"name":"AboutUS - Footer","section_enabled":"active","Sec10_title":"About Support Desk","Sec10_info":"Support Desk is a comprehensive helpdesk ticket management tool designed to streamline customer support operations. It enables businesses to efficiently manage incoming support requests, track ticket status, and provide timely assistance to customers.","section_footer_image_path":"","section_main_image_path":"","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <h4 class="my-3 text-white">About Support Desk</h4>
                            ...
                            <div class="col-md-8">
                                <div class="row g-4">
                                    ...
                                    <div class="col-6 col-md-3 wow fadeInUp" data-wow-delay="0.6s">
                                        <h5 class="mb-3 mb-sm-4 text-white">Support Desk Eco-System</h5>
                                        <ul class="list-unstyled footer-link">
